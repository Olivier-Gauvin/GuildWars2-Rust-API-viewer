...
pub async fn api_call<Endpoint: EndpointProvider>(
    ...
    let resource = match endpoint {
        ...
        "items" | "itemstats" | "recipes" | "recipes/search" | "finishers" | "pvp/amulets" | "materials" => match ids {
...
// Implement the trait for AccountCall enum
...
impl EndpointProvider for Guild {
    fn get_endpoint(&self) -> &'static str {
        match self {
            ...
            Guild::Permission => "guild/permissions",
            Guild::GuildSearch => "guild/search",
